        ...
        <div class="advantage">
          ...
          <div class="advantage__w">
            <div class="advantage__img-w">
              <img class="advantage__img" src="/icons/cardAdvantage1.svg" alt="" />
            </div>
            <div class="advantage__img-w">
              <img class="advantage__img" src="/icons/cardAdvantage2.svg" alt="" />
            </div>
            <div class="advantage__img-w">
              <img class="advantage__img" src="/icons/cardAdvantage3.svg" alt="" />
            </div>
            <div class="advantage__img-w">
              <img class="advantage__img" src="/icons/cardAdvantage4.svg" alt="" />
            </div>
            <div class="advantage__img-w">
              <img class="advantage__img" src="/icons/cardAdvantage5.svg" alt="" />
            </div>
            <div class="advantage__img-w">
              <img class="advantage__img" src="/icons/cardAdvantage6.svg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <!--       <div class="price__info-facilities-availability">В наличии</div>
              <div class="price__info-facilities-item">
                <img
                  ...
                  src="/icons/cardPriceDelivery.svg"
                  alt=""
                />
        ...
        <div class="payments">
          ...
          <div class="payments__w">
            <div class="payments__item">
              <img class="payments__item-img" src="/icons/cardGooglePay.svg" alt="" />
            </div>
            <div class="payments__item">
              <img class="payments__item-img" src="/icons/cardApplePay.svg" alt="" />
            </div>
            <div class="payments__item">
              <img class="payments__item-img" src="/icons/card24Pay.svg" alt="" />
            </div>
            <div class="payments__item">
              <img class="payments__item-img" src="/icons/cardVisaPay.svg" alt="" />
            </div>
            <div class="payments__item">
              <img class="payments__item-img" src="/icons/cardMastercardPay.svg" alt="" />
            </div>
            <div class="payments__item">
              <img class="payments__item-img" src="/icons/cardInstallmentPay.svg" alt="" />
            </div>
            <div class="payments__item">
              <img class="payments__item-img" src="/icons/cardInInstallmentPay.svg" alt="" />
            </div>
            <div class="payments__item">
      ...
      <div class="info__block">
        <div class="guarantee">
          ...
          <div class="guarantee__info">
            <img class="guarantee__info-img" src="/icons/cardGuarantee.svg" alt="" />
