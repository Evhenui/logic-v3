<template>
  <section class="office-services">
    <div class="office-services__wrapper">
      <DescriptionSection class="office-services__description">
        <p class="office-services__description-text">
      ...
      <Capabilities 
        class="office-services__capabilities"
        :title="'Система безопасности позволяет:'"
      >
        <template v-slot:card>

          <CardCapabilities 
            class="office-services__capabilities-card"
      ...
      <InstallerBunner class="office-services__bunner" />
      ...
      <BasicSet 
        class="office-services__set"
        :title="'Пример базового комплекта оборудования для системы видеонаблюдения в офисе'"
      >
        <template v-slot:cards>

          <CardBasicSet 
            class="office-services__set-card"
        ...
        <template v-slot:description>
          <p class="office-services__description-text slim">
      ...
      <Location 
        class="office-services__location"
        :row="true"
      ...
      >
        <template v-slot:cards>
          ...
          <CardLocation 
            class="office-services__location-card"
          ...
          >
            <template v-slot:item>
              <CheckItem 
                class="office-services__price-item"
      ...
      <ServicePrice 
        class="office-services__service-price"
        :title="prices.title"
        :price="prices.price"
        :img="prices.img"
      >
      ...
      <Offers 
        class="office-services__offers"
        :title="offers.main.title"
      >
        <template v-slot:item>
          <div class="office-services__offer-section">
            <CheckItem 
              class="office-services__offer-item"
      ...
      <Promt class="office-services__promt" />

      <SchemeLocation 
        class="office-services__scheme"
        :img="'office'"
      >
      </SchemeLocation>

      <ContactUs class="office-services__contacts" />
    </div>
  </section>
</template>
...
const capabilities = [
  {img: 'clock', title: 'Учет рабочего времени персонала'},
  {img: 'thief', title: 'Предотвращение злоупотреблений и краж'},
  {img: 'control', title: 'Контроль передвижений по офису'},
  {img: 'resolving-issues', title: 'Доказательства при решении спорных вопросов'},
]

const basicSet = [
  {number: '4' ,img: 'camera-big', description: 'Купольная IP камера'},
  {number: '4' ,img: 'camera', description: 'Наружная IP камера'},
  {number: '1' ,img: 'dvr', description: 'Видеорегистратор NVR'},
  {number: '1' ,img: 'hdmi', description: 'Коммуникатор сетевой POE'},
  {number: '8' ,img: 'switch', description: 'Сплиттер POE 48-12V'},
...
const location = {
  subtitlte: 'Профессиональные монтажные бригады GreenVision имеют огромный практический опыт в организации систем видеонаблюдения на различных объектах. Выполняем работы качественно и в срок.',
  values: [
    {img: 'doors', title: 'Входы в офис'},
    {img: 'corridor', title: 'Коридор'},
    {img: 'corners', title: 'corners-icon'},
  ]
}

const prices = {
  title: 'Что входит в услугу установки типового комплекта видеонаблюдения в офисе?',
  price: '63 200 ГРН',
  description: [
    ...
    'Видеорегистратор с накопителем объемом 1ТВ'
  ],
  img: 'office'
}
...
const offers = {
  main: {
    ...
    descritions: {
      ...
      'Прокладка кабеля открытым способом не более 20 метров до камеры (крепление стяжки; клипсы; под армрстронгом, без сверления отверстий для фиксации кабельной трассы) на высоте до 3 метров ',
  ...
  additionally: {
    ...
    descritions: {
      sectionLeft: [
      'Настройка удаленного просмотра на 2 устройствах через протокол Р2Р (обучение пользователя, просмотр записей, сохранение записи на usp или в память телефона)',
      ],
      sectionRight: [
